const stages = [
  ...
  { id: "quality-analysis", name: "质量分析模型", implementation: "RandomForest process model + quality scoring adapter", next: "decision", status: "ready" },
  { id: "decision", name: "质量决策", implementation: "Risk bands + evidence fusion + knowledge recommendations", next: "persistence", status: "ready" },
...
function getPipeline() {
  return {
    ...
    modelPlan: {
      ...
      analysisAdapter: "RandomForestRegressor + classification and risk scoring"
    }
  };
}
